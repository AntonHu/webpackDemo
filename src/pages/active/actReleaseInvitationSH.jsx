 ...
 * @LastEditors: Anton
 * @LastEditTime: 2020-06-18 19:45:03
 */
import '@/styles/active/actReleaseInvitationSH.scss';
...
var InviteShare = React.createClass({
    ...
    downloadImage: function () {
        ...
        if ( !APP_TOOLS.isPC() ) {
            window.location.replace(window.location.origin + '/campaign/active/actInvitationImageSH.html?name=' + name);
            return;
        }
        _this.showLoading();
        ...
        return (
            <div id="page-actReleaseInvitation">
                <div id="release-container" className="release-container">
                    ...
                    >
                        <img className="html-bg" src={APP_CONFIG.STATIC_URL + 'wechat/images/active/actReleaseInvitationSH.jpg'} />
                        <div className="operation">
                            <input className="name-input" placeholder="请输入" onChange={this.nameChange} 
                                value={name}
                                style={{
                                    marginTop: countVH(188),
                                    fontSize: countVH(20)
                                }}
                            />
