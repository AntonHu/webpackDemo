...
var Login = React.createClass({
    ...
    modalPopstate: function () {
        ...
        if (
            window.location.href.indexOf('agreementModal') > 0 ||
            window.location.href.indexOf('privacyAgreement') > 0
        ) {
            window.history.back();
            if (APP_TOOLS.isWechatClient() == 'zfb' && window.ap) {
                ap.setNavigationBar({
                ...
                <div ref="content">
                    ...
                    <div className="weui_cells weui_cells_form">
                        <div className="weui_cell" style={inputWrapper}>
                            <div className="weui_cell_hd">
                                <label className="weui_label" style={inputLabel}>
                                    手机号
                                </label>
                            </div>
                    ...
                    <div className="weui_cells weui_cells_form" style={{ marginTop: '-1px' }}>
                        <div className="weui_cell weui_vcode" style={inputWrapper}>
                            ...
                            <div className="weui_cell_ft">
                                <div ref="codeBtn" style={codeBtnStyle} onClick={this.sendCode}>
                                    获取验证码
                                </div>
                            </div>
                        </div>
                    ...
                    <div style={btnWrapper}>
                        <a
                            ...
                            style={{ fontSize: '16px', lineHeight: '42px', background: '#fdd903', color: '#333' }}
