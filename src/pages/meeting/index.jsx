        ...
        return(
            <div className="page">
                <div className="bg-wrapper">
                    <img width="100%" src='https://source.1kmxc.com/static-web-new/wechat/images/active/meeting/main_bg.png' />
                </div>
                {
                    type == RESULT_TYPE.RESULT_NORMAL && (<div className="resultNormal">
                        <div className="resultNormal-wrapper">
                            <div className="title">报名已结束,感谢您的支持！</div>
                        </div>
                        <div className="schedule-wrapper">
                            <div className="title" style={{ visibility: 'hidden' }}>—— 发布会日程 ——</div>
                            ...
                            <div className="tip">
                                <div>如未能到现场</div>
                                <div onClick={this.gotoLivevod}>您还可以<span className="line">观看现场直播视频</span></div>
                            </div>
                        </div>
                    </div>)
                }
                        ...
                        <div className="main-wrapper">
                            <div className="info-wrapper">
                                <div className="info-box">
                                    ...
                                    <div className="subtitle">{distributeInfo.f_name +"   "+ distributeInfo.f_mobile}</div>
                                    {
                                        type == RESULT_TYPE.RESULT_SUCCESS ? (
                                            <div>
                                                <div className="subtitle" style={{display: distributeInfo.f_seat_num ? "":"none"}}>发布会现场座位： {distributeInfo.f_seat_num}</div>
                                                <div className="subtitle" onClick={this.playNavigation.bind(this, 2)} style={{display: distributeInfo.f_eat_status == 1 ? "":"none"}}>
                                ...
                                <button className="btn" onClick={this.playNavigation.bind(this, 1)}>导航到会场</button>
                            </div>
                            <div className="schedule-wrapper">
            ...
            <div className="dialog-modal">
                {
                    type == RESULT_TYPE.RESULT_SUCCESS ? (
                        <div className="dialog-wrapper">
                            ...
                            <div className="subtitle">嘉宾席位预约成功，发布会将于6月17日在杭州国际博览中心举行，请安排好您的行程以免错过精彩时刻。</div>
                            <div className="btn" onClick={this.onSure}>确定</div>
                        </div>
                    ): null
                }
                {
                    type == RESULT_TYPE.RESULT_CHECK ? (
                        <div className="dialog-wrapper">
                            ...
                            <div className="subtitle">感谢您的关注，因为参加人员较多，工作人员会尽量安排现场名额，我们会第一时间通知您。</div>
                            <div className="btn" onClick={this.onSure}>确定</div>
                        </div>
                    ): null
                }
