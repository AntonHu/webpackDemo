...
var VIDEO_LIST = [{
    id: 1,
    title: "冬天可洗",
    description: "冬日洗车最大的挑战是遇到毛刷结冰，不仅无法正常清洗还可能对车漆造成不可逆的伤害。阿尔法独有的密闭式暖芯系统，可对毛刷内暖自热大幅降低运营成本，让严寒下的冬日洗车成为可能。",
    preImage: APP_CONFIG.STATIC_URL + 'wechat/images/active/meeting/scene-1.jpg'
}, {
    id: 2,
    title: "高场地适应性",
    description: "仅有一个冰箱的大小的阿尔法，其场地比龙门机小25%，比隧道机小50%，还能轻松驾驭不同的路面，甚至是石板路。这让它可以方便的进入小区，地下车库等空间有限的地方。",
    ...
    id: 3,
    title: "安全避障",
    description: "阿尔法新一代安全感知系统可动态感知知周围环境，若遇到障碍物闯入，立即停止，待障碍物离开后继续刷洗，确保安全。",
    ...
    id: 4,
    title: "灵活刷洗",
    description: "阿尔法可智能检测出所洗车辆的表面轮廓数据及其他加装物，并针对性地制定毛刷的刷洗角度和安全策略，确保千车千面的洗车效果。",
    ...
    id: 5,
    title: "高效协同",
    description: "归功于阿尔法高效的智能协同控制系统，多台阿尔法可以协同清洗同一辆车，最快55秒就可以完成清洗，比市面上的隧道式洗车机还要高效40%。",
    preImage: APP_CONFIG.STATIC_URL + 'wechat/images/active/meeting/meeting-video-img-5.jpg'
}, {
    id: 6,
    title: "永不停机",
    description: "当多台阿尔法机器人在一起清洗同一辆车时，如果其中一台阿尔法出现了故障，其他机器会立刻改写清洗程序，补充到故障位置中去，保证清洗质量。",
    ...
    id: 7,
    title: "总部统一维修",
    description: "阿尔法的设计高度精简和模块化，所有的零配件，甚至是整机，遇到故障后均由快递发货至总部维修中心统一维修，确保维修品质和维修效率。",
                        ...
                        <div className="detail-box-introduction">
                            <div className="introduction-header">
                                ...
                                <div className="introduction-btn-group">
                                    {!isPC() &&  <img className="share-btn" onClick={this.goToShare} src={APP_CONFIG.STATIC_URL + 'wechat/images/active/meeting/share-btn.png'} />}
                            ...
                            <div className="video-list-container">
                                <div className="video-item" onClick={_this.goToLive}>
                                    <div className="video-image" >
                                        <img src={APP_CONFIG.STATIC_URL + 'wechat/images/active/meeting/record-img.jpg'} />
                                    </div>
...

                        {
                            st.messageList.length > 1 ? (
                                <div className="detail-box-video-list">
                                    ...
                                    <div className="video-list-container">
                                        {VIDEO_LIST.filter(
                                            videoItem => (st.messageList.filter(
                                                msgItem => msgItem.contentJson.id == videoItem.id
