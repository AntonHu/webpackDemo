                ...
                <div className="container">
                    ...
                    {data.id ? (
                        <div
                            ...
                            style={{
                                right: this.state.ifModalShow
                                    ? '30px'
                                    : (-483 * document.body.clientWidth) / 1920 + 'px',
                                transition: 'ease-in-out 1s'
                            }}
                        >
                            <img
                                className="message-modal-close-img"
                                onClick={this.state.ifModalShow ? this.hideModal : this.showModal}
                                src={
                                    APP_CONFIG.STATIC_URL +
                                    (this.state.ifModalShow
                                        ? 'wechat/images/active/meeting/close_image.png'
                                        : 'wechat/images/active/meeting/open_image.png')
                                }
                            />
                            <img
                                className="message-modal-main-img"
                                src={APP_CONFIG.STATIC_URL + 'wechat/images/active/meeting/video' + data.id + '.png'}
                            />
                        </div>
                    ) : null}
                </div>
